...
void cohesive_zones_t::initialize(Mesh_t& mesh, State_t& State){
    ...
    const double tol = 1e-8; //0.000001; //e-3; // adjust as needed; added just in case coordinate pairs are close but not exactly equa
