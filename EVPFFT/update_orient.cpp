...
//
      loc_reduce.array[0] += SQRT(POW2(rotslip(3,2)) + POW2(rotslip(1,3)) + POW2(rotslip(2,1))) * wgt;
      loc_reduce.array[1] += SQRT(POW2(rotloc(3,2)) + POW2(rotloc(1,3)) + POW2(rotloc(2,1))) * wgt;
