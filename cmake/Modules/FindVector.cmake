...
# Allow for non-native arch targets for cross-compiling
if(NOT DEFINED VECTOR_ARCH_FLAGS)
    if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
        set(VECTOR_ARCH_FLAGS "-march=native -mtune=native")
    elseif("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
        set(VECTOR_ARCH_FLAGS "-march=native -mtune=native")
    elseif("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
        set(VECTOR_ARCH_FLAGS "-mcpu=powerpc64le")
    endif()
endif()
...
if(CMAKE_C_COMPILER_LOADED)
    if ("${CMAKE_C_COMPILER_ID}" STREQUAL "Clang") # using Clang
        ...
        if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
           set(VECTOR_ARCH_C_FLAGS "${VECTOR_ARCH_C_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
            set(VECTOR_ARCH_C_FLAGS "${VECTOR_ARCH_C_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
            set(VECTOR_ARCH_C_FLAGS "${VECTOR_ARCH_C_FLAGS} ${VECTOR_ARCH_FLAGS}")
    ...
    elseif ("${CMAKE_C_COMPILER_ID}" STREQUAL "AppleClang") # using AppleClang
        set(VECTOR_ALIASING_C_FLAGS "${VECTOR_ALIASING_C_FLAGS} -fstrict-aliasing")
        if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
           set(VECTOR_ARCH_C_FLAGS "${VECTOR_ARCH_C_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
    ...
    elseif ("${CMAKE_C_COMPILER_ID}" STREQUAL "Intel") # using Intel C
        ...
        set(VECTOR_C_OPTS "${VECTOR_C_OPTS} ${VECTOR_ARCH_FLAGS} -xHOST -vecabi=cmdtarget")
        ...
        set(VECTOR_NOVEC_C_OPT "${VECTOR_NOVEC_C_OPT} ${VECTOR_ARCH_FLAGS} -no-vec")
...
if(CMAKE_CXX_COMPILER_LOADED)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang") # using Clang
        ...
        if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
           set(VECTOR_ARCH_CXX_FLAGS "${VECTOR_ARCH_CXX_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
            set(VECTOR_ARCH_CXX_FLAGS "${VECTOR_ARCH_CXX_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
            set(VECTOR_ARCH_CXX_FLAGS "${VECTOR_ARCH_CXX_FLAGS} ${VECTOR_ARCH_FLAGS}")
    ...
    elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang") # using AppleClang
        set(VECTOR_ALIASING_CXX_FLAGS "${VECTOR_ALIASING_CXX_FLAGS} -fstrict-aliasing")
        if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
           set(VECTOR_ARCH_CXX_FLAGS "${VECTOR_ARCH_CXX_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
    ...
    elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel") # using Intel C
        ...
        set(VECTOR_CXX_OPTS "${VECTOR_CXX_OPTS} ${VECTOR_ARCH_FLAGS} -xHOST -vecabi=cmdtarget")
        ...
        set(VECTOR_NOVEC_CXX_OPT "${VECTOR_NOVEC_CXX_OPT} ${VECTOR_ARCH_FLAGS} -no-vec")
...
if(CMAKE_Fortran_COMPILER_LOADED)
    if ("${CMAKE_Fortran_COMPILER_ID}" STREQUAL "Clang") # using Clang
        ...
        if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
           set(VECTOR_ARCH_Fortran_FLAGS "${VECTOR_ARCH_Fortran_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
            set(VECTOR_ARCH_Fortran_FLAGS "${VECTOR_ARCH_Fortran_FLAGS} ${VECTOR_ARCH_FLAGS}")
        elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "aarch64")
            set(VECTOR_ARCH_Fortran_FLAGS "${VECTOR_ARCH_Fortran_FLAGS} ${VECTOR_ARCH_FLAGS}")
    ...
    elseif ("${CMAKE_Fortran_COMPILER_ID}" STREQUAL "Intel") # using Intel C
        ...
        set(VECTOR_Fortran_OPTS "${VECTOR_Fortran_OPTS} ${VECTOR_ARCH_FLAGS} -xHOST -vecabi=cmdtarget")
        ...
        set(VECTOR_NOVEC_Fortran_OPT "${VECTOR_NOVEC_Fortran_OPT} ${VECTOR_ARCH_FLAGS} -no-vec")
