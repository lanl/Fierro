...
public:
  ...
  KOKKOS_FUNCTION
  IdealGasEOSModel(const RUN_LOCATION run_loc,
  ...
  KOKKOS_FUNCTION
  int calc_sound_speed(const DViewCArrayKokkos <double> &elem_pres,
  ...
  KOKKOS_FUNCTION
  int calc_pressure(const DViewCArrayKokkos <double> &elem_pres,
                    const DViewCArrayKokkos <double> &elem_stress,
                    const size_t elem_gid,
                    const size_t mat_id,
                    const DCArrayKokkos <double> &global_vars,
