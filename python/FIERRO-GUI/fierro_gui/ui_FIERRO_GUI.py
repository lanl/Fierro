...
################################################################################
## Form generated from reading UI file 'FIERRO_GUIjLltol.ui'
##
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.ParaviewFrame.sizePolicy().hasHeightForWidth())
        self.ParaviewFrame.setSizePolicy(sizePolicy2)
        ...
        self.LPipelineSelection.setFont(font5)
        ...
        self.LPartName_3.setFont(font5)
        ...
        self.BUploadGeometryFile.setFont(font5)
        ...
        self.SAGeometryScrollArea.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        ...
        self.BVoxelizeGeometry.setGeometry(QRect(4, 422, 340, 21))
        self.BVoxelizeGeometry.setFont(font4)
        ...
        self.TParts.setGeometry(QRect(4, 448, 341, 180))
        ...
        self.BDeleteGeometry.setGeometry(QRect(4, 632, 340, 21))
        sizePolicy7 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.BDeleteGeometry.sizePolicy().hasHeightForWidth())
        self.BDeleteGeometry.setSizePolicy(sizePolicy7)
        self.BDeleteGeometry.setMaximumSize(QSize(450, 22))
        self.layoutWidget = QWidget(self.ImportPartTool)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(4, 38, 340, 380))
        ...
        self.LNumberOfVoxelsX = QLabel(self.layoutWidget)
        ...
        self.LNumberOfVoxelsX.setFont(font7)
        ...
        self.INNumberOfVoxelsX = QLineEdit(self.layoutWidget)
        ...
        self.INNumberOfVoxelsX.setFont(font4)
        ...
        self.INNumberOfVoxelsY.setFont(font4)
        ...
        self.INNumberOfVoxelsZ.setFont(font4)
        ...
        self.LVoxelCount = QLabel(self.layoutWidget)
        ...
        self.verticalLayout_8.addLayout(self.formLayout_23)
        ...
        self.LDimensions = QLabel(self.layoutWidget)
        ...
        self.BCustomDimensions = QRadioButton(self.layoutWidget)
        ...
        sizePolicy8.setHeightForWidth(self.BCustomDimensions.sizePolicy().hasHeightForWidth())
        self.BCustomDimensions.setSizePolicy(sizePolicy8)
        self.BCustomDimensions.setFont(font4)

        self.verticalLayout_8.addWidget(self.BCustomDimensions)

        self.BStlDimensions = QRadioButton(self.layoutWidget)
        self.BStlDimensions.setObjectName(u"BStlDimensions")
        self.BStlDimensions.setEnabled(False)
        self.BStlDimensions.setFont(font4)
        ...
        self.formLayout_39.setFormAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        self.LLengthX = QLabel(self.layoutWidget)
        self.LLengthX.setObjectName(u"LLengthX")
        self.LLengthX.setEnabled(False)
        self.LLengthX.setFont(font4)

        self.formLayout_39.setWidget(0, QFormLayout.LabelRole, self.LLengthX)

        self.LLengthY = QLabel(self.layoutWidget)
        self.LLengthY.setObjectName(u"LLengthY")
        self.LLengthY.setEnabled(False)
        self.LLengthY.setFont(font4)

        self.formLayout_39.setWidget(1, QFormLayout.LabelRole, self.LLengthY)

        self.INLengthY = QLineEdit(self.layoutWidget)
        self.INLengthY.setObjectName(u"INLengthY")
        self.INLengthY.setEnabled(False)
        sizePolicy1.setHeightForWidth(self.INLengthY.sizePolicy().hasHeightForWidth())
        self.INLengthY.setSizePolicy(sizePolicy1)
        self.INLengthY.setMinimumSize(QSize(208, 0))
        self.INLengthY.setFont(font4)
        ...
        self.LLengthZ = QLabel(self.layoutWidget)
        self.LLengthZ.setObjectName(u"LLengthZ")
        self.LLengthZ.setEnabled(False)
        self.LLengthZ.setFont(font4)

        self.formLayout_39.setWidget(2, QFormLayout.LabelRole, self.LLengthZ)

        self.INLengthZ = QLineEdit(self.layoutWidget)
        self.INLengthZ.setObjectName(u"INLengthZ")
        self.INLengthZ.setEnabled(False)
        sizePolicy1.setHeightForWidth(self.INLengthZ.sizePolicy().hasHeightForWidth())
        self.INLengthZ.setSizePolicy(sizePolicy1)
        self.INLengthZ.setMinimumSize(QSize(208, 0))
        self.INLengthZ.setFont(font4)
        ...
        self.INLengthX = QLineEdit(self.layoutWidget)
        self.INLengthX.setObjectName(u"INLengthX")
        self.INLengthX.setEnabled(False)
        sizePolicy1.setHeightForWidth(self.INLengthX.sizePolicy().hasHeightForWidth())
        self.INLengthX.setSizePolicy(sizePolicy1)
        self.INLengthX.setMinimumSize(QSize(208, 0))
        self.INLengthX.setFont(font4)
        ...
        self.verticalLayout_8.addLayout(self.formLayout_39)
        ...
        self.LImageFileFormat.setFont(font9)
        ...
        self.layoutWidget1 = QWidget(self.ImportImageStackTool)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(36, 92, 277, 32))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.BImageToVTK = QPushButton(self.layoutWidget1)
        ...
        self.BTiffToStl = QPushButton(self.layoutWidget1)
        ...
        self.LUploadedDirectory.setFont(font9)
        ...
        self.LImageStack_2.setGeometry(QRect(28, 5, 300, 25))
        ...
        self.BDeleteDream = QPushButton(self.page_13)
        self.BDeleteDream.setObjectName(u"BDeleteDream")
        self.BDeleteDream.setGeometry(QRect(5, 228, 339, 22))
        sizePolicy7.setHeightForWidth(self.BDeleteDream.sizePolicy().hasHeightForWidth())
        self.BDeleteDream.setSizePolicy(sizePolicy7)
        self.BDeleteDream.setMaximumSize(QSize(450, 22))
        self.TDream = QTableWidget(self.page_13)
        if (self.TDream.columnCount() < 1):
            self.TDream.setColumnCount(1)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.TDream.setHorizontalHeaderItem(0, __qtablewidgetitem10)
        self.TDream.setObjectName(u"TDream")
        self.TDream.setEnabled(True)
        self.TDream.setGeometry(QRect(5, 78, 339, 144))
        sizePolicy2.setHeightForWidth(self.TDream.sizePolicy().hasHeightForWidth())
        self.TDream.setSizePolicy(sizePolicy2)
        self.TDream.setMaximumSize(QSize(10000, 180))
        self.TDream.setFont(font1)
        self.TDream.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.TDream.setRowCount(0)
        self.layoutWidget_5 = QWidget(self.page_13)
        self.layoutWidget_5.setObjectName(u"layoutWidget_5")
        self.layoutWidget_5.setGeometry(QRect(5, 103, 16, 16))
        self.formLayout_10 = QFormLayout(self.layoutWidget_5)
        self.formLayout_10.setObjectName(u"formLayout_10")
        self.formLayout_10.setContentsMargins(0, 0, 0, 0)
        self.layoutWidget2 = QWidget(self.page_13)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(5, 46, 339, 32))
        self.gridLayout_7 = QGridLayout(self.layoutWidget2)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.LColorBy = QLabel(self.layoutWidget2)
        ...
        sizePolicy9.setHeightForWidth(self.LColorBy.sizePolicy().hasHeightForWidth())
        self.LColorBy.setSizePolicy(sizePolicy9)

        self.gridLayout_7.addWidget(self.LColorBy, 0, 0, 1, 1)

        self.INSelectColorBy = QComboBox(self.layoutWidget2)
        self.INSelectColorBy.addItem("")
        self.INSelectColorBy.addItem("")
        self.INSelectColorBy.addItem("")
        self.INSelectColorBy.addItem("")
        self.INSelectColorBy.setObjectName(u"INSelectColorBy")
        self.INSelectColorBy.setEnabled(False)

        self.gridLayout_7.addWidget(self.INSelectColorBy, 0, 1, 1, 1)
        ...
        self.TBasicGeometries.setHorizontalHeaderItem(0, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(1, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(2, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(3, __qtablewidgetitem14)
        __qtablewidgetitem15 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(4, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(5, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(6, __qtablewidgetitem17)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(7, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(8, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(9, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(10, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(11, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        self.TBasicGeometries.setHorizontalHeaderItem(12, __qtablewidgetitem23)
        ...
        self.layoutWidget3 = QWidget(self.GenerateMeshTool)
        self.layoutWidget3.setObjectName(u"layoutWidget3")
        self.layoutWidget3.setGeometry(QRect(16, 6, 369, 1346))
        self.verticalLayout = QVBoxLayout(self.layoutWidget3)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.LDefineGlobalMesh = QLabel(self.layoutWidget3)
        ...
        self.MeshInputs = QFrame(self.layoutWidget3)
        ...
        sizePolicy10.setHeightForWidth(self.LElementType.sizePolicy().hasHeightForWidth())
        self.LElementType.setSizePolicy(sizePolicy10)
        ...
        sizePolicy7.setHeightForWidth(self.INElementType.sizePolicy().hasHeightForWidth())
        self.INElementType.setSizePolicy(sizePolicy7)
        ...
        sizePolicy10.setHeightForWidth(self.LCoordinateSystem.sizePolicy().hasHeightForWidth())
        self.LCoordinateSystem.setSizePolicy(sizePolicy10)
        ...
        sizePolicy7.setHeightForWidth(self.INCoordinateSystem.sizePolicy().hasHeightForWidth())
        self.INCoordinateSystem.setSizePolicy(sizePolicy7)
        ...
        sizePolicy10.setHeightForWidth(self.LDimension.sizePolicy().hasHeightForWidth())
        self.LDimension.setSizePolicy(sizePolicy10)
        ...
        sizePolicy7.setHeightForWidth(self.INDimension.sizePolicy().hasHeightForWidth())
        self.INDimension.setSizePolicy(sizePolicy7)
        ...
        self.MeshInputs2 = QStackedWidget(self.layoutWidget3)
        ...
        self.BGenerateGlobalMesh = QPushButton(self.layoutWidget3)
        ...
        self.LNumberOfSteps.setGeometry(QRect(4, 20, 109, 22))
        ...
        self.INNumberOfSteps.setGeometry(QRect(120, 20, 251, 22))
        ...
        self.TBoundaryConditions.setHorizontalHeaderItem(0, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(1, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(2, __qtablewidgetitem26)
        __qtablewidgetitem27 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(3, __qtablewidgetitem27)
        __qtablewidgetitem28 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(4, __qtablewidgetitem28)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(5, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.TBoundaryConditions.setHorizontalHeaderItem(6, __qtablewidgetitem30)
        ...
        self.layoutWidget4 = QWidget(self.page_6)
        self.layoutWidget4.setObjectName(u"layoutWidget4")
        self.layoutWidget4.setGeometry(QRect(0, 4, 380, 341))
        self.verticalLayout_4 = QVBoxLayout(self.layoutWidget4)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.BoundaryConditionsInputs = QFrame(self.layoutWidget4)
        ...
        self.BAddBC = QPushButton(self.layoutWidget4)
        self.BAddBC.setObjectName(u"BAddBC")

        self.verticalLayout_4.addWidget(self.BAddBC)

        self.TBCs = QTableWidget(self.layoutWidget4)
        if (self.TBCs.columnCount() < 2):
            self.TBCs.setColumnCount(2)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.TBCs.setHorizontalHeaderItem(0, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.TBCs.setHorizontalHeaderItem(1, __qtablewidgetitem32)
        ...
        self.BDeleteBC = QPushButton(self.layoutWidget4)
        self.BDeleteBC.setObjectName(u"BDeleteBC")
        ...
        self.BAddMaterialSGH.setGeometry(QRect(3, 92, 351, 30))
        self.frame_16 = QFrame(self.DefineMaterialsSGH)
        ...
        sizePolicy1.setHeightForWidth(self.Lq1ex.sizePolicy().hasHeightForWidth())
        self.Lq1ex.setSizePolicy(sizePolicy1)
        ...
        self.BDeleteMaterialSGH.setGeometry(QRect(3, 288, 351, 30))
        ...
        self.TMaterialsSGH.setHorizontalHeaderItem(0, __qtablewidgetitem33)
        __qtablewidgetitem34 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(1, __qtablewidgetitem34)
        __qtablewidgetitem35 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(2, __qtablewidgetitem35)
        __qtablewidgetitem36 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(3, __qtablewidgetitem36)
        __qtablewidgetitem37 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(4, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(5, __qtablewidgetitem38)
        __qtablewidgetitem39 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(6, __qtablewidgetitem39)
        __qtablewidgetitem40 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(7, __qtablewidgetitem40)
        __qtablewidgetitem41 = QTableWidgetItem()
        self.TMaterialsSGH.setHorizontalHeaderItem(8, __qtablewidgetitem41)
        ...
        self.label_12 = QLabel(self.DefineMaterialsSGH)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(4, 320, 353, 21))
        font11 = QFont()
        font11.setPointSize(11)
        self.label_12.setFont(font11)
        self.frame_7 = QFrame(self.DefineMaterialsSGH)
        self.frame_7.setObjectName(u"frame_7")
        self.frame_7.setGeometry(QRect(9, 8, 331, 78))
        ...
        sizePolicy9.setHeightForWidth(self.LMaterialNameSGH.sizePolicy().hasHeightForWidth())
        self.LMaterialNameSGH.setSizePolicy(sizePolicy9)
        ...
        sizePolicy11.setHeightForWidth(self.INMaterialNameSGH.sizePolicy().hasHeightForWidth())
        self.INMaterialNameSGH.setSizePolicy(sizePolicy11)
        ...
        self.LEOS.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.BAddMaterial.setGeometry(QRect(0, 299, 353, 30))
        ...
        self.TAnisotropic.setItem(0, 0, __qtablewidgetitem42)
        ...
        self.TAnisotropic.setItem(1, 0, __qtablewidgetitem43)
        ...
        self.TAnisotropic.setItem(2, 0, __qtablewidgetitem44)
        ...
        self.TAnisotropic.setItem(2, 1, __qtablewidgetitem45)
        ...
        self.TAnisotropic.setItem(3, 0, __qtablewidgetitem46)
        ...
        self.TAnisotropic.setItem(3, 1, __qtablewidgetitem47)
        ...
        self.TAnisotropic.setItem(3, 2, __qtablewidgetitem48)
        ...
        self.TAnisotropic.setItem(4, 0, __qtablewidgetitem49)
        ...
        self.TAnisotropic.setItem(4, 1, __qtablewidgetitem50)
        ...
        self.TAnisotropic.setItem(4, 2, __qtablewidgetitem51)
        ...
        self.TAnisotropic.setItem(4, 3, __qtablewidgetitem52)
        ...
        self.TAnisotropic.setItem(5, 0, __qtablewidgetitem53)
        ...
        self.TAnisotropic.setItem(5, 1, __qtablewidgetitem54)
        ...
        self.TAnisotropic.setItem(5, 2, __qtablewidgetitem55)
        ...
        self.TAnisotropic.setItem(5, 3, __qtablewidgetitem56)
        ...
        self.TAnisotropic.setItem(5, 4, __qtablewidgetitem57)
        ...
        self.TMaterials.setHorizontalHeaderItem(0, __qtablewidgetitem58)
        __qtablewidgetitem59 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(1, __qtablewidgetitem59)
        __qtablewidgetitem60 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(2, __qtablewidgetitem60)
        __qtablewidgetitem61 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(3, __qtablewidgetitem61)
        __qtablewidgetitem62 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(4, __qtablewidgetitem62)
        __qtablewidgetitem63 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(5, __qtablewidgetitem63)
        __qtablewidgetitem64 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(6, __qtablewidgetitem64)
        __qtablewidgetitem65 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(7, __qtablewidgetitem65)
        __qtablewidgetitem66 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(8, __qtablewidgetitem66)
        __qtablewidgetitem67 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(9, __qtablewidgetitem67)
        __qtablewidgetitem68 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(10, __qtablewidgetitem68)
        __qtablewidgetitem69 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(11, __qtablewidgetitem69)
        __qtablewidgetitem70 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(12, __qtablewidgetitem70)
        __qtablewidgetitem71 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(13, __qtablewidgetitem71)
        __qtablewidgetitem72 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(14, __qtablewidgetitem72)
        __qtablewidgetitem73 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(15, __qtablewidgetitem73)
        __qtablewidgetitem74 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(16, __qtablewidgetitem74)
        __qtablewidgetitem75 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(17, __qtablewidgetitem75)
        __qtablewidgetitem76 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(18, __qtablewidgetitem76)
        __qtablewidgetitem77 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(19, __qtablewidgetitem77)
        __qtablewidgetitem78 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(20, __qtablewidgetitem78)
        __qtablewidgetitem79 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(21, __qtablewidgetitem79)
        __qtablewidgetitem80 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(22, __qtablewidgetitem80)
        __qtablewidgetitem81 = QTableWidgetItem()
        self.TMaterials.setHorizontalHeaderItem(23, __qtablewidgetitem81)
        ...
        self.INSelectAssignMaterials.setGeometry(QRect(6, 6, 361, 22))
        ...
        self.AssignMaterialsOptions.setGeometry(QRect(5, 28, 362, 549))
        self.page_4 = QWidget()
        self.page_4.setObjectName(u"page_4")
        self.layoutWidget_2 = QWidget(self.page_4)
        self.layoutWidget_2.setObjectName(u"layoutWidget_2")
        self.layoutWidget_2.setGeometry(QRect(220, 96, 142, 103))
        self.formLayout_19 = QFormLayout(self.layoutWidget_2)
        self.formLayout_19.setObjectName(u"formLayout_19")
        self.formLayout_19.setVerticalSpacing(7)
        ...
        self.formLayout_19.setWidget(1, QFormLayout.LabelRole, self.LVelx)
        ...
        self.formLayout_19.setWidget(1, QFormLayout.FieldRole, self.INVelocityX)
        ...
        self.formLayout_19.setWidget(2, QFormLayout.LabelRole, self.LVely)
        ...
        self.formLayout_19.setWidget(2, QFormLayout.FieldRole, self.INVelocityY)
        ...
        self.formLayout_19.setWidget(3, QFormLayout.LabelRole, self.LVelz)
        ...
        self.formLayout_19.setWidget(3, QFormLayout.FieldRole, self.INVelocityZ)

        self.label_4 = QLabel(self.layoutWidget_2)
        self.label_4.setObjectName(u"label_4")

        self.formLayout_19.setWidget(0, QFormLayout.SpanningRole, self.label_4)

        self.layoutWidget_4 = QWidget(self.page_4)
        self.layoutWidget_4.setObjectName(u"layoutWidget_4")
        self.layoutWidget_4.setGeometry(QRect(2, 96, 204, 102))
        self.verticalLayout_14 = QVBoxLayout(self.layoutWidget_4)
        ...
        self.verticalLayout_14.addWidget(self.LSIE)

        self.INSIE = QLineEdit(self.layoutWidget_4)
        self.INSIE.setObjectName(u"INSIE")
        self.INSIE.setEnabled(True)

        self.verticalLayout_14.addWidget(self.INSIE)

        self.layoutWidget_3 = QWidget(self.page_4)
        self.layoutWidget_3.setObjectName(u"layoutWidget_3")
        self.layoutWidget_3.setGeometry(QRect(3, 8, 360, 64))
        self.formLayout_18 = QFormLayout(self.layoutWidget_3)
        self.formLayout_18.setObjectName(u"formLayout_18")
        self.formLayout_18.setContentsMargins(0, 0, 0, 0)
        self.LMaterialName_4 = QLabel(self.layoutWidget_3)
        self.LMaterialName_4.setObjectName(u"LMaterialName_4")
        self.LMaterialName_4.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)

        self.formLayout_18.setWidget(0, QFormLayout.LabelRole, self.LMaterialName_4)

        self.INPartMaterial = QComboBox(self.layoutWidget_3)
        self.INPartMaterial.setObjectName(u"INPartMaterial")

        self.formLayout_18.setWidget(0, QFormLayout.FieldRole, self.INPartMaterial)

        self.LRegion_4 = QLabel(self.layoutWidget_3)
        self.LRegion_4.setObjectName(u"LRegion_4")
        self.LRegion_4.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)

        self.formLayout_18.setWidget(1, QFormLayout.LabelRole, self.LRegion_4)

        self.INMaterial = QComboBox(self.layoutWidget_3)
        self.INMaterial.setObjectName(u"INMaterial")

        self.formLayout_18.setWidget(1, QFormLayout.FieldRole, self.INMaterial)

        self.Tassignmat = QTableWidget(self.page_4)
        if (self.Tassignmat.columnCount() < 7):
            self.Tassignmat.setColumnCount(7)
        __qtablewidgetitem82 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(0, __qtablewidgetitem82)
        __qtablewidgetitem83 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(1, __qtablewidgetitem83)
        __qtablewidgetitem84 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(2, __qtablewidgetitem84)
        __qtablewidgetitem85 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(3, __qtablewidgetitem85)
        __qtablewidgetitem86 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(4, __qtablewidgetitem86)
        __qtablewidgetitem87 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(5, __qtablewidgetitem87)
        __qtablewidgetitem88 = QTableWidgetItem()
        self.Tassignmat.setHorizontalHeaderItem(6, __qtablewidgetitem88)
        self.Tassignmat.setObjectName(u"Tassignmat")
        self.Tassignmat.setGeometry(QRect(4, 232, 358, 192))
        self.Baddmaterialassignment = QPushButton(self.page_4)
        self.Baddmaterialassignment.setObjectName(u"Baddmaterialassignment")
        self.Baddmaterialassignment.setGeometry(QRect(3, 204, 359, 22))
        self.Bdeletematerialassignment = QPushButton(self.page_4)
        self.Bdeletematerialassignment.setObjectName(u"Bdeletematerialassignment")
        self.Bdeletematerialassignment.setGeometry(QRect(4, 485, 357, 22))
        self.frame_17 = QFrame(self.page_4)
        self.frame_17.setObjectName(u"frame_17")
        self.frame_17.setGeometry(QRect(3, 420, 357, 69))
        ...
        self.horizontalLayout_20.addWidget(self.BUpMaterial)
        ...
        self.horizontalLayout_20.addWidget(self.BDownMaterial)

        self.AssignMaterialsOptions.addWidget(self.page_4)
        self.page_5 = QWidget()
        self.page_5.setObjectName(u"page_5")
        self.LRegion = QLabel(self.page_5)
        self.LRegion.setObjectName(u"LRegion")
        self.LRegion.setGeometry(QRect(4, 12, 46, 22))
        self.INRegion = QComboBox(self.page_5)
        self.INRegion.addItem("")
        self.INRegion.addItem("")
        self.INRegion.setObjectName(u"INRegion")
        self.INRegion.setGeometry(QRect(56, 12, 305, 22))
        self.AssignMaterialsOptions.addWidget(self.page_5)
        icon10 = QIcon()
        icon10.addFile(u":/Blue Icons/Blue Icons/Clipboard.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.tabWidget.addTab(self.AssignMaterials, icon10, "")
        ...
        sizePolicy12.setHeightForWidth(self.BRunSGH.sizePolicy().hasHeightForWidth())
        self.BRunSGH.setSizePolicy(sizePolicy12)
        font12 = QFont()
        font12.setPointSize(12)
        font12.setBold(True)
        self.BRunSGH.setFont(font12)
        ...
        sizePolicy12.setHeightForWidth(self.BRunEVPFFT.sizePolicy().hasHeightForWidth())
        self.BRunEVPFFT.setSizePolicy(sizePolicy12)
        self.BRunEVPFFT.setFont(font12)
        self.BRunEVPFFT.setIcon(icon8)
        self.BRunEVPFFT.setIconSize(QSize(24, 24))
        self.RunOptions.addWidget(self.page_12)
        self.layoutWidget5 = QWidget(self.page_7)
        self.layoutWidget5.setObjectName(u"layoutWidget5")
        self.layoutWidget5.setGeometry(QRect(8, 1, 385, 113))
        self.verticalLayout_9 = QVBoxLayout(self.layoutWidget5)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.verticalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.LRun = QLabel(self.layoutWidget5)
        ...
        self.INRunSelection = QComboBox(self.layoutWidget5)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/Blue Icons/Blue Icons/crop.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.BThreshold.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/Blue Icons/Blue Icons/FirstFrame.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.BFirstFrame.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/Blue Icons/Blue Icons/PreviousFrame.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.BPreviousFrame.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/Blue Icons/Blue Icons/NextFrame.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.BNextFrame.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Blue Icons/Blue Icons/LastFrame.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.BLastFrame.setIcon(icon15)
        ...
        self.BOpenParaviewSGH.setGeometry(QRect(4, 160, 352, 30))
        self.frame_15 = QFrame(self.page_11)
        self.frame_15.setObjectName(u"frame_15")
        self.frame_15.setGeometry(QRect(84, 40, 185, 30))
        ...
        self.BOpenParaview.setGeometry(QRect(0, 69, 364, 30))
        ...
        self.THomogenization.setHorizontalHeaderItem(0, __qtablewidgetitem89)
        if (self.THomogenization.rowCount() < 12):
            self.THomogenization.setRowCount(12)
        __qtablewidgetitem90 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(0, __qtablewidgetitem90)
        __qtablewidgetitem91 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(1, __qtablewidgetitem91)
        __qtablewidgetitem92 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(2, __qtablewidgetitem92)
        __qtablewidgetitem93 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(3, __qtablewidgetitem93)
        __qtablewidgetitem94 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(4, __qtablewidgetitem94)
        __qtablewidgetitem95 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(5, __qtablewidgetitem95)
        __qtablewidgetitem96 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(6, __qtablewidgetitem96)
        __qtablewidgetitem97 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(7, __qtablewidgetitem97)
        __qtablewidgetitem98 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(8, __qtablewidgetitem98)
        __qtablewidgetitem99 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(9, __qtablewidgetitem99)
        __qtablewidgetitem100 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(10, __qtablewidgetitem100)
        __qtablewidgetitem101 = QTableWidgetItem()
        self.THomogenization.setVerticalHeaderItem(11, __qtablewidgetitem101)
        ...
        self.BPreviewResults.setGeometry(QRect(0, 43, 364, 30))
        ...
        icon16 = QIcon()
        icon16.addFile(u":/Blue Icons/Blue Icons/magnify.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon16.addFile(u":/Blue Icons/Blue Icons/magnify.svg", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        ...
        QWidget.setTabOrder(self.BVoxelizeGeometry, self.BImageToVTK)
        QWidget.setTabOrder(self.BImageToVTK, self.BTiffToStl)
        QWidget.setTabOrder(self.BTiffToStl, self.INSelectColorBy)
        QWidget.setTabOrder(self.INSelectColorBy, self.TDream)
        QWidget.setTabOrder(self.TDream, self.BDeleteDream)
        QWidget.setTabOrder(self.BDeleteDream, self.INSelectBasicGeometry)
        ...
        QWidget.setTabOrder(self.INBoxz2, self.INSphereri)
        ...
        QWidget.setTabOrder(self.BDeleteBasicGeometry, self.INElementType)
        ...
        QWidget.setTabOrder(self.INDimension, self.INOriginXR3D)
        ...
        QWidget.setTabOrder(self.INLengthXR2D, self.INLengthYR2D)
        QWidget.setTabOrder(self.INLengthYR2D, self.INElementsXR2D)
        QWidget.setTabOrder(self.INElementsXR2D, self.INElementsYR2D)
        ...
        QWidget.setTabOrder(self.BGenerateGlobalMesh, self.NavigationMenu)
        QWidget.setTabOrder(self.NavigationMenu, self.BAddBC)
        QWidget.setTabOrder(self.BAddBC, self.INSelectSolverSettings)
        ...
        QWidget.setTabOrder(self.INGraphicsOutput, self.INNumberOfSteps)
        QWidget.setTabOrder(self.INNumberOfSteps, self.INSelectBoundaryConditions)
        ...
        QWidget.setTabOrder(self.INVel1, self.RunOutputWindow)
        QWidget.setTabOrder(self.RunOutputWindow, self.INVelstart)
        QWidget.setTabOrder(self.INVelstart, self.INVelend)
        QWidget.setTabOrder(self.INVelend, self.INBoundaryCondition)
        ...
        QWidget.setTabOrder(self.BdeleteBC, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.INSelectDefineMaterials)
        ...
        QWidget.setTabOrder(self.INSpecificHeat, self.INMaterialName)
        QWidget.setTabOrder(self.INMaterialName, self.INSolidGas)
        QWidget.setTabOrder(self.INSolidGas, self.INMaterialType)
        QWidget.setTabOrder(self.INMaterialType, self.INYoungsModulus)
        ...
        QWidget.setTabOrder(self.TAnisotropic, self.INEx)
        ...
        QWidget.setTabOrder(self.INGyz, self.BAddMaterial)
        ...
        QWidget.setTabOrder(self.INSelectAssignMaterials, self.TBCs)
        QWidget.setTabOrder(self.TBCs, self.INPartMaterial)
        QWidget.setTabOrder(self.INPartMaterial, self.INMaterial)
        ...
        QWidget.setTabOrder(self.Bdeletematerialassignment, self.INRegion)
        QWidget.setTabOrder(self.INRegion, self.INRunSelection)
        QWidget.setTabOrder(self.INRunSelection, self.BRunSGH)
        QWidget.setTabOrder(self.BRunSGH, self.BRunEVPFFT)
        QWidget.setTabOrder(self.BRunEVPFFT, self.tabWidget_2)
        ...
        QWidget.setTabOrder(self.BOpenParaviewSGH, self.INBCFile)
        QWidget.setTabOrder(self.INBCFile, self.INPreviewResults)
        QWidget.setTabOrder(self.INPreviewResults, self.INResultRegion)
        QWidget.setTabOrder(self.INResultRegion, self.BPreviewResults)
        QWidget.setTabOrder(self.BPreviewResults, self.BOpenParaview)
        QWidget.setTabOrder(self.BOpenParaview, self.THomogenization)
        QWidget.setTabOrder(self.THomogenization, self.TParts)
        QWidget.setTabOrder(self.TParts, self.INPipelineSelection)
        QWidget.setTabOrder(self.INPipelineSelection, self.ParaviewFrame)
        QWidget.setTabOrder(self.ParaviewFrame, self.BDeleteGeometry)
        QWidget.setTabOrder(self.BDeleteGeometry, self.GeometryOptions)
        QWidget.setTabOrder(self.GeometryOptions, self.BDeleteBC)
        QWidget.setTabOrder(self.BDeleteBC, self.SAGeometryScrollArea)
        QWidget.setTabOrder(self.SAGeometryScrollArea, self.graphicsView)
        ...
        self.NavigationMenu.setCurrentIndex(1)
        self.OutputWindows.setCurrentIndex(0)
        self.ToolWindow.setCurrentIndex(6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.INPipelineSelection.setItemText(0, QCoreApplication.translate("MainWindow", u"Input/Output", None))
        ...
        self.LImageStack.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-weight:700;\">Image Stack Conversion</span></p><p align=\"center\"><br/></p></body></html>", None))
        ...
        self.LImageStack_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-weight:700;\">Dream3D Viewer</span></p><p align=\"center\"><br/></p></body></html>", None))
        self.BDeleteDream.setText(QCoreApplication.translate("MainWindow", u"Delete Geometry", None))
        ___qtablewidgetitem10 = self.TDream.horizontalHeaderItem(0)
        ...
        self.INSelectColorBy.setItemText(0, QCoreApplication.translate("MainWindow", u"Euler Angles", None))
        self.INSelectColorBy.setItemText(1, QCoreApplication.translate("MainWindow", u"Feature Ids", None))
        self.INSelectColorBy.setItemText(2, QCoreApplication.translate("MainWindow", u"IPF Color", None))
        self.INSelectColorBy.setItemText(3, QCoreApplication.translate("MainWindow", u"Phases", None))
        ...
        ___qtablewidgetitem11 = self.TBasicGeometries.horizontalHeaderItem(0)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"Name", None));
        ___qtablewidgetitem12 = self.TBasicGeometries.horizontalHeaderItem(1)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"Type", None));
        ___qtablewidgetitem13 = self.TBasicGeometries.horizontalHeaderItem(2)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"x1", None));
        ___qtablewidgetitem14 = self.TBasicGeometries.horizontalHeaderItem(3)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", u"x2", None));
        ___qtablewidgetitem15 = self.TBasicGeometries.horizontalHeaderItem(4)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("MainWindow", u"y1", None));
        ___qtablewidgetitem16 = self.TBasicGeometries.horizontalHeaderItem(5)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow", u"y2", None));
        ___qtablewidgetitem17 = self.TBasicGeometries.horizontalHeaderItem(6)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"z1", None));
        ___qtablewidgetitem18 = self.TBasicGeometries.horizontalHeaderItem(7)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"z2", None));
        ___qtablewidgetitem19 = self.TBasicGeometries.horizontalHeaderItem(8)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"Inner Radius", None));
        ___qtablewidgetitem20 = self.TBasicGeometries.horizontalHeaderItem(9)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"Outer Radius", None));
        ___qtablewidgetitem21 = self.TBasicGeometries.horizontalHeaderItem(10)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"Origin x", None));
        ___qtablewidgetitem22 = self.TBasicGeometries.horizontalHeaderItem(11)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"Origin y", None));
        ___qtablewidgetitem23 = self.TBasicGeometries.horizontalHeaderItem(12)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("MainWindow", u"Origin z", None));
        ...
        ___qtablewidgetitem24 = self.TBoundaryConditions.horizontalHeaderItem(0)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("MainWindow", u"Boundary", None));
        ___qtablewidgetitem25 = self.TBoundaryConditions.horizontalHeaderItem(1)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("MainWindow", u"Plane Position", None));
        ___qtablewidgetitem26 = self.TBoundaryConditions.horizontalHeaderItem(2)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("MainWindow", u"Type", None));
        ___qtablewidgetitem27 = self.TBoundaryConditions.horizontalHeaderItem(3)
        ___qtablewidgetitem27.setText(QCoreApplication.translate("MainWindow", u"vel_0", None));
        ___qtablewidgetitem28 = self.TBoundaryConditions.horizontalHeaderItem(4)
        ___qtablewidgetitem28.setText(QCoreApplication.translate("MainWindow", u"vel_1", None));
        ___qtablewidgetitem29 = self.TBoundaryConditions.horizontalHeaderItem(5)
        ___qtablewidgetitem29.setText(QCoreApplication.translate("MainWindow", u"vel_t_start", None));
        ___qtablewidgetitem30 = self.TBoundaryConditions.horizontalHeaderItem(6)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("MainWindow", u"vel_t_end", None));
        ...
        ___qtablewidgetitem31 = self.TBCs.horizontalHeaderItem(0)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("MainWindow", u"Boundary Condition", None));
        ___qtablewidgetitem32 = self.TBCs.horizontalHeaderItem(1)
        ___qtablewidgetitem32.setText(QCoreApplication.translate("MainWindow", u"Direction", None));
        ...
        ___qtablewidgetitem33 = self.TMaterialsSGH.horizontalHeaderItem(0)
        ___qtablewidgetitem33.setText(QCoreApplication.translate("MainWindow", u"Name", None));
        ___qtablewidgetitem34 = self.TMaterialsSGH.horizontalHeaderItem(1)
        ___qtablewidgetitem34.setText(QCoreApplication.translate("MainWindow", u"EOS", None));
        ___qtablewidgetitem35 = self.TMaterialsSGH.horizontalHeaderItem(2)
        ___qtablewidgetitem35.setText(QCoreApplication.translate("MainWindow", u"q1", None));
        ___qtablewidgetitem36 = self.TMaterialsSGH.horizontalHeaderItem(3)
        ___qtablewidgetitem36.setText(QCoreApplication.translate("MainWindow", u"q2", None));
        ___qtablewidgetitem37 = self.TMaterialsSGH.horizontalHeaderItem(4)
        ___qtablewidgetitem37.setText(QCoreApplication.translate("MainWindow", u"q1ex", None));
        ___qtablewidgetitem38 = self.TMaterialsSGH.horizontalHeaderItem(5)
        ___qtablewidgetitem38.setText(QCoreApplication.translate("MainWindow", u"q2ex", None));
        ___qtablewidgetitem39 = self.TMaterialsSGH.horizontalHeaderItem(6)
        ___qtablewidgetitem39.setText(QCoreApplication.translate("MainWindow", u"gamma", None));
        ___qtablewidgetitem40 = self.TMaterialsSGH.horizontalHeaderItem(7)
        ___qtablewidgetitem40.setText(QCoreApplication.translate("MainWindow", u"min sound speed", None));
        ___qtablewidgetitem41 = self.TMaterialsSGH.horizontalHeaderItem(8)
        ___qtablewidgetitem41.setText(QCoreApplication.translate("MainWindow", u"specific heat", None));
        ...
        ___qtablewidgetitem42 = self.TMaterials.horizontalHeaderItem(0)
        ___qtablewidgetitem42.setText(QCoreApplication.translate("MainWindow", u"Name", None));
        ___qtablewidgetitem43 = self.TMaterials.horizontalHeaderItem(1)
        ___qtablewidgetitem43.setText(QCoreApplication.translate("MainWindow", u"Region", None));
        ___qtablewidgetitem44 = self.TMaterials.horizontalHeaderItem(2)
        ___qtablewidgetitem44.setText(QCoreApplication.translate("MainWindow", u"Type", None));
        ___qtablewidgetitem45 = self.TMaterials.horizontalHeaderItem(3)
        ___qtablewidgetitem45.setText(QCoreApplication.translate("MainWindow", u"C11", None));
        ___qtablewidgetitem46 = self.TMaterials.horizontalHeaderItem(4)
        ___qtablewidgetitem46.setText(QCoreApplication.translate("MainWindow", u"C12", None));
        ___qtablewidgetitem47 = self.TMaterials.horizontalHeaderItem(5)
        ___qtablewidgetitem47.setText(QCoreApplication.translate("MainWindow", u"C13", None));
        ___qtablewidgetitem48 = self.TMaterials.horizontalHeaderItem(6)
        ___qtablewidgetitem48.setText(QCoreApplication.translate("MainWindow", u"C14", None));
        ___qtablewidgetitem49 = self.TMaterials.horizontalHeaderItem(7)
        ___qtablewidgetitem49.setText(QCoreApplication.translate("MainWindow", u"C15", None));
        ___qtablewidgetitem50 = self.TMaterials.horizontalHeaderItem(8)
        ___qtablewidgetitem50.setText(QCoreApplication.translate("MainWindow", u"C16", None));
        ___qtablewidgetitem51 = self.TMaterials.horizontalHeaderItem(9)
        ___qtablewidgetitem51.setText(QCoreApplication.translate("MainWindow", u"C22", None));
        ___qtablewidgetitem52 = self.TMaterials.horizontalHeaderItem(10)
        ___qtablewidgetitem52.setText(QCoreApplication.translate("MainWindow", u"C23", None));
        ___qtablewidgetitem53 = self.TMaterials.horizontalHeaderItem(11)
        ___qtablewidgetitem53.setText(QCoreApplication.translate("MainWindow", u"C24", None));
        ___qtablewidgetitem54 = self.TMaterials.horizontalHeaderItem(12)
        ___qtablewidgetitem54.setText(QCoreApplication.translate("MainWindow", u"C25", None));
        ___qtablewidgetitem55 = self.TMaterials.horizontalHeaderItem(13)
        ___qtablewidgetitem55.setText(QCoreApplication.translate("MainWindow", u"C26", None));
        ___qtablewidgetitem56 = self.TMaterials.horizontalHeaderItem(14)
        ___qtablewidgetitem56.setText(QCoreApplication.translate("MainWindow", u"C33", None));
        ___qtablewidgetitem57 = self.TMaterials.horizontalHeaderItem(15)
        ___qtablewidgetitem57.setText(QCoreApplication.translate("MainWindow", u"C34", None));
        ___qtablewidgetitem58 = self.TMaterials.horizontalHeaderItem(16)
        ___qtablewidgetitem58.setText(QCoreApplication.translate("MainWindow", u"C35", None));
        ___qtablewidgetitem59 = self.TMaterials.horizontalHeaderItem(17)
        ___qtablewidgetitem59.setText(QCoreApplication.translate("MainWindow", u"C36", None));
        ___qtablewidgetitem60 = self.TMaterials.horizontalHeaderItem(18)
        ___qtablewidgetitem60.setText(QCoreApplication.translate("MainWindow", u"C44", None));
        ___qtablewidgetitem61 = self.TMaterials.horizontalHeaderItem(19)
        ___qtablewidgetitem61.setText(QCoreApplication.translate("MainWindow", u"C45", None));
        ___qtablewidgetitem62 = self.TMaterials.horizontalHeaderItem(20)
        ___qtablewidgetitem62.setText(QCoreApplication.translate("MainWindow", u"C46", None));
        ___qtablewidgetitem63 = self.TMaterials.horizontalHeaderItem(21)
        ___qtablewidgetitem63.setText(QCoreApplication.translate("MainWindow", u"C55", None));
        ___qtablewidgetitem64 = self.TMaterials.horizontalHeaderItem(22)
        ___qtablewidgetitem64.setText(QCoreApplication.translate("MainWindow", u"C56", None));
        ___qtablewidgetitem65 = self.TMaterials.horizontalHeaderItem(23)
        ___qtablewidgetitem65.setText(QCoreApplication.translate("MainWindow", u"C66", None));
        ...
        self.INSelectAssignMaterials.setItemText(1, QCoreApplication.translate("MainWindow", u"EVPFFT", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Velocity", None))
        ...
        self.LRegion_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"right\">Material:</p></body></html>", None))
        ___qtablewidgetitem66 = self.Tassignmat.horizontalHeaderItem(0)
        ___qtablewidgetitem66.setText(QCoreApplication.translate("MainWindow", u"Part", None));
        ___qtablewidgetitem67 = self.Tassignmat.horizontalHeaderItem(1)
        ___qtablewidgetitem67.setText(QCoreApplication.translate("MainWindow", u"Material", None));
        ___qtablewidgetitem68 = self.Tassignmat.horizontalHeaderItem(2)
        ___qtablewidgetitem68.setText(QCoreApplication.translate("MainWindow", u"Density", None));
        ___qtablewidgetitem69 = self.Tassignmat.horizontalHeaderItem(3)
        ___qtablewidgetitem69.setText(QCoreApplication.translate("MainWindow", u"Specific Internal Energy", None));
        ___qtablewidgetitem70 = self.Tassignmat.horizontalHeaderItem(4)
        ___qtablewidgetitem70.setText(QCoreApplication.translate("MainWindow", u"Velocity X", None));
        ___qtablewidgetitem71 = self.Tassignmat.horizontalHeaderItem(5)
        ___qtablewidgetitem71.setText(QCoreApplication.translate("MainWindow", u"Velocity Y", None));
        ___qtablewidgetitem72 = self.Tassignmat.horizontalHeaderItem(6)
        ___qtablewidgetitem72.setText(QCoreApplication.translate("MainWindow", u"Velocity Z", None));
        ...
        ___qtablewidgetitem73 = self.THomogenization.horizontalHeaderItem(0)
        ___qtablewidgetitem73.setText(QCoreApplication.translate("MainWindow", u"Homogenized Elastic Constants", None));
        ___qtablewidgetitem74 = self.THomogenization.verticalHeaderItem(0)
        ___qtablewidgetitem74.setText(QCoreApplication.translate("MainWindow", u"Exx", None));
        ___qtablewidgetitem75 = self.THomogenization.verticalHeaderItem(1)
        ___qtablewidgetitem75.setText(QCoreApplication.translate("MainWindow", u"Eyy", None));
        ___qtablewidgetitem76 = self.THomogenization.verticalHeaderItem(2)
        ___qtablewidgetitem76.setText(QCoreApplication.translate("MainWindow", u"Ezz", None));
        ___qtablewidgetitem77 = self.THomogenization.verticalHeaderItem(3)
        ___qtablewidgetitem77.setText(QCoreApplication.translate("MainWindow", u"NUxy", None));
        ___qtablewidgetitem78 = self.THomogenization.verticalHeaderItem(4)
        ___qtablewidgetitem78.setText(QCoreApplication.translate("MainWindow", u"NUyx", None));
        ___qtablewidgetitem79 = self.THomogenization.verticalHeaderItem(5)
        ___qtablewidgetitem79.setText(QCoreApplication.translate("MainWindow", u"NUxz", None));
        ___qtablewidgetitem80 = self.THomogenization.verticalHeaderItem(6)
        ___qtablewidgetitem80.setText(QCoreApplication.translate("MainWindow", u"NUzx", None));
        ___qtablewidgetitem81 = self.THomogenization.verticalHeaderItem(7)
        ___qtablewidgetitem81.setText(QCoreApplication.translate("MainWindow", u"NUyz", None));
        ___qtablewidgetitem82 = self.THomogenization.verticalHeaderItem(8)
        ___qtablewidgetitem82.setText(QCoreApplication.translate("MainWindow", u"NUzy", None));
        ___qtablewidgetitem83 = self.THomogenization.verticalHeaderItem(9)
        ___qtablewidgetitem83.setText(QCoreApplication.translate("MainWindow", u"Gxy", None));
        ___qtablewidgetitem84 = self.THomogenization.verticalHeaderItem(10)
        ___qtablewidgetitem84.setText(QCoreApplication.translate("MainWindow", u"Gxz", None));
        ___qtablewidgetitem85 = self.THomogenization.verticalHeaderItem(11)
        ___qtablewidgetitem85.setText(QCoreApplication.translate("MainWindow", u"Gyz", None));
