...
################################################################################
## Form generated from reading UI file 'FIERRO_GUIxLpxUp.ui'
##
...
"}")
        ...
        self.LSTLVoxelization.setFont(font5)
        ...
        self.widget = QWidget(self.ImportPartTool)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(4, 38, 340, 377))
        ...
        self.LNumberOfVoxelsX = QLabel(self.widget)
        self.LNumberOfVoxelsX.setObjectName(u"LNumberOfVoxelsX")
        self.LNumberOfVoxelsX.setEnabled(False)
        font6 = QFont()
        font6.setFamilies([u"Hiragino Sans"])
        font6.setPointSize(9)
        font6.setBold(False)
        font6.setItalic(False)
        font6.setKerning(True)
        self.LNumberOfVoxelsX.setFont(font6)
        ...
        self.INNumberOfVoxelsX = QLineEdit(self.widget)
        ...
        self.INNumberOfVoxelsX.setFont(font7)
        ...
        self.INNumberOfVoxelsY.setFont(font7)
        ...
        self.INNumberOfVoxelsZ.setFont(font7)
        ...
        self.LVoxelCount = QLabel(self.widget)
        ...
        self.LOriginX = QLabel(self.widget)
        ...
        self.INOriginX = QLineEdit(self.widget)
        ...
        self.LOriginY = QLabel(self.widget)
        ...
        self.INOriginY = QLineEdit(self.widget)
        ...
        self.LOriginZ = QLabel(self.widget)
        ...
        self.INOriginZ = QLineEdit(self.widget)
        ...
        self.LOriginPoint = QLabel(self.widget)
        ...
        self.LDimensions = QLabel(self.widget)
        ...
        self.BCustomDimensions = QRadioButton(self.widget)
        ...
        self.LLengthX = QLabel(self.widget)
        ...
        self.LLengthY = QLabel(self.widget)
        ...
        self.INLengthY = QLineEdit(self.widget)
        ...
        self.LLengthZ = QLabel(self.widget)
        ...
        self.INLengthZ = QLineEdit(self.widget)
        self.INLengthZ.setObjectName(u"INLengthZ")
        self.INLengthZ.setEnabled(False)
        sizePolicy7.setHeightForWidth(self.INLengthZ.sizePolicy().hasHeightForWidth())
        self.INLengthZ.setSizePolicy(sizePolicy7)
        ...
        self.INLengthX = QLineEdit(self.widget)
        self.INLengthX.setObjectName(u"INLengthX")
        self.INLengthX.setEnabled(False)
        sizePolicy7.setHeightForWidth(self.INLengthX.sizePolicy().hasHeightForWidth())
        self.INLengthX.setSizePolicy(sizePolicy7)
        ...
        self.layoutWidget = QWidget(self.ImportImageStackTool)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(36, 92, 277, 24))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.BImageToVTK = QPushButton(self.layoutWidget)
        ...
        self.BTiffToStl = QPushButton(self.layoutWidget)
        ...
        self.widget1 = QWidget(self.page_13)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(6, 46, 339, 24))
        self.gridLayout_7 = QGridLayout(self.widget1)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.LColorBy = QLabel(self.widget1)
        ...
        self.INSelectColorBy = QComboBox(self.widget1)
        ...
        self.layoutWidget1 = QWidget(self.GenerateMeshTool)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(16, 6, 369, 1346))
        self.verticalLayout = QVBoxLayout(self.layoutWidget1)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.LDefineGlobalMesh = QLabel(self.layoutWidget1)
        ...
        self.MeshInputs = QFrame(self.layoutWidget1)
        ...
        self.MeshInputs2 = QStackedWidget(self.layoutWidget1)
        ...
        self.BGenerateGlobalMesh = QPushButton(self.layoutWidget1)
        ...
        self.layoutWidget2.setGeometry(QRect(0, 4, 380, 341))
        self.verticalLayout_4 = QVBoxLayout(self.layoutWidget2)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.BoundaryConditionsInputs = QFrame(self.layoutWidget2)
        ...
        self.BAddBC = QPushButton(self.layoutWidget2)
        self.BAddBC.setObjectName(u"BAddBC")

        self.verticalLayout_4.addWidget(self.BAddBC)

        self.TBCs = QTableWidget(self.layoutWidget2)
        ...
        self.BDeleteBC = QPushButton(self.layoutWidget2)
        self.BDeleteBC.setObjectName(u"BDeleteBC")
        ...
        self.layoutWidget_4.setGeometry(QRect(2, 96, 204, 101))
        ...
        self.layoutWidget_3.setGeometry(QRect(3, 8, 360, 57))
        ...
        sizePolicy11.setHeightForWidth(self.BRunSGH.sizePolicy().hasHeightForWidth())
        self.BRunSGH.setSizePolicy(sizePolicy11)
        font13 = QFont()
        ...
        sizePolicy11.setHeightForWidth(self.BRunEVPFFT.sizePolicy().hasHeightForWidth())
        self.BRunEVPFFT.setSizePolicy(sizePolicy11)
        ...
        self.layoutWidget3 = QWidget(self.page_7)
        self.layoutWidget3.setObjectName(u"layoutWidget3")
        self.layoutWidget3.setGeometry(QRect(8, 1, 385, 113))
        self.verticalLayout_9 = QVBoxLayout(self.layoutWidget3)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.verticalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.LRun = QLabel(self.layoutWidget3)
        ...
        self.INRunSelection = QComboBox(self.layoutWidget3)
        ...
        QWidget.setTabOrder(self.INEOS, self.BRunEVPFFT)
        QWidget.setTabOrder(self.BRunEVPFFT, self.INYoungsModulus)
        ...
        QWidget.setTabOrder(self.TAnisotropic, self.BRunSGH)
        QWidget.setTabOrder(self.BRunSGH, self.INRunSelection)
        QWidget.setTabOrder(self.INRunSelection, self.BDeleteMaterial)
        ...
        QWidget.setTabOrder(self.tabWidget_2, self.INPipelineSelection)
        QWidget.setTabOrder(self.INPipelineSelection, self.TParts)
        QWidget.setTabOrder(self.TParts, self.BDeleteGeometry)
        QWidget.setTabOrder(self.BDeleteGeometry, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.INSelectDefineMaterials)
        QWidget.setTabOrder(self.INSelectDefineMaterials, self.INMaterialName)
        ...
        self.AssignMaterialsOptions.setCurrentIndex(1)
        self.RunOptions.setCurrentIndex(1)
