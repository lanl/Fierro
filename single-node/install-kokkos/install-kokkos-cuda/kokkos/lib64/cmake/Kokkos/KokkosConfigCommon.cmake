...
SET(Kokkos_OPTIONS CUDA_RELOCATABLE_DEVICE_CODE;DEPRECATED_CODE_3;DEPRECATION_WARNINGS;LAUNCH_COMPILER;IMPL_DESUL_ATOMICS;CUDA_LAMBDA;COMPLEX_ALIGN;CUDA_CONSTEXPR)
SET(Kokkos_TPLS CUDA;LIBDL)
SET(Kokkos_ARCH NATIVE;VOLTA70)
SET(Kokkos_CXX_COMPILER "/projects/opt/centos8/x86_64/gcc/9.4.0/bin/g++")
...
FUNCTION(kokkos_compilation)
    ...
    SET(_HINTS "${CMAKE_CURRENT_LIST_DIR}/../.." "/vast/home/ddunning/playground/Fierro/single-node/install-kokkos/install-kokkos-cuda/kokkos")
