...
struct mesh_t {
    ...
    // get local node_id from global elem and node ids
    CArrayKokkos <size_t> local_node_id_in_elem;

    // elem ids in zone
    CArrayKokkos <size_t> elems_in_zone;
    CArrayKokkos <size_t> local_zone_id_in_elem;
    ...
    void build_corner_connectivity(){
        ...
        local_node_id_in_elem = CArrayKokkos <size_t> (num_nodes, num_elems);
        ...
        for (size_t elem_gid = 0; elem_gid < num_elems; elem_gid++){
            FOR_ALL_CLASS(node_lid, 0, num_nodes_in_elem, {
                ...
                local_node_id_in_elem(node_gid, elem_gid) = node_lid;
        ...
        size_t num_zones = num_zones_in_elem*num_elems;
