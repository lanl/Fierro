...
namespace ConstantEOSModel
{
      ...
      const size_t num_elems)
    {
      ...
      */
      ...
      FOR_ALL(elem_gid, 0, num_elems, {
        ...
        if (material.host(mat_id).eos_model == EOS_MODEL::constant) {
  ...
  void calc_sound_speed(
    ...
    const double sie)
  {
    double sound_speed = eos_global_vars(mat_id,0);
    double pressure = eos_global_vars(mat_id,1);

    // sound speed
    elem_sspd(elem_gid) = sound_speed;
...
} // end namespace ConstantEOSModel