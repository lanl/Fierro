...
std::tuple<DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, unsigned int> binary_stl_reader(const char* stl_file_path); // BINARY STL READER FUNCTION
void main_function(DCArrayKokkos<bool> &gridOUTPUT, int &gridX, int &gridY, int &gridZ, DCArrayKokkos<float> &normal, DCArrayKokkos<float> &v1X, DCArrayKokkos<float> &v1Y, DCArrayKokkos<float> &v1Z, DCArrayKokkos<float> &v2X, DCArrayKokkos<float> &v2Y, DCArrayKokkos<float> &v2Z, DCArrayKokkos<float> &v3X, DCArrayKokkos<float> &v3Y, DCArrayKokkos<float> &v3Z, unsigned int &n_facets, DCArrayKokkos<float> &nodex, DCArrayKokkos<float> &nodey, DCArrayKokkos<float> &nodez); // VOXELIZATION FUNCTION
...
//    {
        ...
        DCArrayKokkos<float> nodex;
        DCArrayKokkos<float> nodey;
        DCArrayKokkos<float> nodez;
        // X-direction voxelization
        DCArrayKokkos<bool> gridOUTPUTX(gridY+2,gridZ+2,gridX+2);
        ...
        DCArrayKokkos<bool> gridOUTPUTY(gridZ+2,gridX+2,gridY+2);
        ...
        DCArrayKokkos<bool> gridOUTPUTZ(gridX+2,gridY+2,gridZ+2);
        ...
        DCArrayKokkos<int> TOTgrid(gridX+2,gridY+2,gridZ+2);
        FOR_LOOP(i,0,gridX+2,
                j,0,gridY+2,
                k,0,gridZ+2,{
        ...
        Kokkos::fence();
        DCArrayKokkos<bool> OUTPUTgrid(gridZ,gridY,gridX);
...
std::tuple<DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, DCArrayKokkos<float>, unsigned int> binary_stl_reader(const char* stl_file_path){
    ...
    DCArrayKokkos<float> normal(n_facets,3);
    DCArrayKokkos<float> v1X(n_facets);
    DCArrayKokkos<float> v1Y(n_facets);
    DCArrayKokkos<float> v1Z(n_facets);
    DCArrayKokkos<float> v2X(n_facets);
    DCArrayKokkos<float> v2Y(n_facets);
    DCArrayKokkos<float> v2Z(n_facets);
    DCArrayKokkos<float> v3X(n_facets);
    DCArrayKokkos<float> v3Y(n_facets);
    DCArrayKokkos<float> v3Z(n_facets);
    float normalp[3];
    float v1p[3];
    float v2p[3];
    float v3p[3];
...
void main_function(DCArrayKokkos<bool> &gridOUTPUT, int &gridX, int &gridY, int &gridZ, DCArrayKokkos<float> &normal, DCArrayKokkos<float> &v1X, DCArrayKokkos<float> &v1Y, DCArrayKokkos<float> &v1Z, DCArrayKokkos<float> &v2X, DCArrayKokkos<float> &v2Y, DCArrayKokkos<float> &v2Z, DCArrayKokkos<float> &v3X, DCArrayKokkos<float> &v3Y, DCArrayKokkos<float> &v3Z, unsigned int &n_facets, DCArrayKokkos<float> &nodex, DCArrayKokkos<float> &nodey, DCArrayKokkos<float> &nodez){
    ...
    int elx = gridX+2;
    DCArrayKokkos<float> gridCOx(elx+1);
    gridCOx(0) = meshXmin;
    ...
    int ely = gridY+2;
    DCArrayKokkos<float> gridCOy(ely+1);
    gridCOy(0) = meshYmin;
    ...
    int elz = gridZ+2;
    DCArrayKokkos<float> gridCOz(elz+1);
    gridCOz(0) = meshZmin;
    ...
    DCArrayKokkos<float> facetXmin(n_facets);
    DCArrayKokkos<float> facetXmax(n_facets);
    DCArrayKokkos<float> facetYmin(n_facets);
    DCArrayKokkos<float> facetYmax(n_facets);
    DCArrayKokkos<float> facetZmin(n_facets);
    DCArrayKokkos<float> facetZmax(n_facets);
    ...
    DCArrayKokkos<int> correctionLIST(ely*elx,2);
    DCArrayKokkos<int> facetCROSSLISTcounter(1);
    ...
    // Initialize variables
    DCArrayKokkos<int> possibleCROSSLIST(n_facets);
    DCArrayKokkos<int> facetCROSSLIST(n_facets);
    DCArrayKokkos<int> vertexCROSSLIST(n_facets);
    DCArrayKokkos<float> coN(n_facets);
    DCArrayKokkos<float> gridCOzCROSS(n_facets);
    DCArrayKokkos<float> gridCOzCROSSunique(n_facets);
    ...
    if (correctionLISTcounter(0) > 0) {
        DCArrayKokkos<int> voxelsforcorrection(1);
        DCArrayKokkos<int> c1(1);
        DCArrayKokkos<int> c2(1);
        DCArrayKokkos<int> c3(1);
        DCArrayKokkos<int> c4(1);
        DCArrayKokkos<int> c5(1);
        DCArrayKokkos<int> c6(1);
        DCArrayKokkos<int> c7(1);
        DCArrayKokkos<int> c8(1);
