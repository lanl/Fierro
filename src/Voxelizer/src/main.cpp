...
int main(int argc, char *argv[]) {
    ...
    double length_x = std::stoi(argv[6]); // size of voxels x-direction
    double length_y = std::stoi(argv[7]); // size of voxels y-direction
    double length_z = std::stoi(argv[8]); // size of voxels z-direction
    /*
...
//    {
    auto voxelizer_output = Voxelizer::create_voxel_vtk(stl_file_path, vtk_file_path, gridX, gridY, gridZ, length_x, length_y, length_z);
//    }
//    Kokkos::finalize();
    return 0;
