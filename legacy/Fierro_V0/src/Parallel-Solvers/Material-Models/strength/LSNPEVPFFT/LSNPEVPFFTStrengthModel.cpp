...
namespace LSNPEVPFFTStrengthModel
{
...
#if BUILD_LSNP_EVPFFT_FIERRO
    FierroLSNPEVPFFTLink::init_strength_state_vars(material,
                                               elem_mat_id,
                                               eos_state_vars,
                                               strength_state_vars,
                                               eos_global_vars,
...
#if BUILD_LSNP_EVPFFT_FIERRO
    FierroLSNPEVPFFTLink::calc_stress(elem_pres,
                                  elem_stress,
                                  elem_gid,
                                  mat_id,
                                  eos_state_vars,
...
} // end namespace LSNPEVPFFTStrengthModel
