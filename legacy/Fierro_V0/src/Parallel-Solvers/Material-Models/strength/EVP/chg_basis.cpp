...
void chg_basis_1(real_t *CE2_, real_t *C2_, int IOPT, int KDIM, real_t *B_basis_) //ptr) const
{
  ...
  ViewCMatrixKokkos <double> CE2(CE2_, KDIM);
  ViewCMatrixKokkos <double> C2(C2_, 3,3);
...
void chg_basis_3(real_t *CE4_, real_t *C4_, int IOPT, int KDIM, real_t *B_basis_) //ptr) const
{
  ...
  ViewCMatrixKokkos <double> CE4(CE4_, KDIM,KDIM);
  ViewCMatrixKokkos <double> C4(C4_, 3,3,3,3);
  ViewCMatrixKokkos <double> B_basis(B_basis_, 3,3,6);
